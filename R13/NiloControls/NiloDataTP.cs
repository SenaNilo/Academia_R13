...
{
    public class NiloDataTP : DateTimePicker
    {
        //Fields
        //-> Appearance
        ...
        private Image calendarIcon = R13.Properties.Resources.calendarWhite;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.8F)
                    calendarIcon = R13.Properties.Resources.calendarDark;
                else calendarIcon = R13.Properties.Resources.calendarWhite;
                this.Invalidate();
            }
        }
